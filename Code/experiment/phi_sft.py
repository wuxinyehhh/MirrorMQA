...
BASE_MODEL_PATH = "models/Phi-4-multimodal-instruct"
CHECKPOINT_PATH = "outputs/lora/Phi4/v2-20260403-172827/checkpoint-600"
...
result_file = f"phi4_lora{ckpt_name}_run{run_idx}.jsonl"
...
# Phi4 这份 checkpoint-600 目录是完整模型权重，不是标准 PEFT adapter 目录。
# 因此这里直接加载 checkpoint 做推理，而不是走 base + PeftModel 的挂载方式。
