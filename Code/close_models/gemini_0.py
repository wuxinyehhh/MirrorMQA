...
IMAGE_DIR = "/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/zhangmanyuan/zhangquan/llm/project/wxy/test_openai/image1"
OUTPUT_FILE = os.path.join(IMAGE_DIR, "predictions_gemini_0.tsv")

# 默认参数配置
DEFAULT_IMAGE_PATH = os.path.join(IMAGE_DIR, "5-0442.png")           # 默认图片路径
