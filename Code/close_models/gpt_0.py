...
MAX_WORKERS = 10
DATA_DIR = "./image"
OUTPUT_FILE = os.path.join(DATA_DIR, "predictions_gpt_0.tsv")

PROMPT = """    "You are a senior expert in visual pattern recognition and mirror-image reasoning. "
...
def clean_tsv():
    """删除 predictions_gpt_0.tsv 中图片文件在 DATA_DIR 下实际不存在的行。"""
